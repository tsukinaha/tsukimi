...
glib::wrapper! {
    ...
    pub struct LeadContainer(Object<ffi::ClapperGtkLeadContainer, ffi::ClapperGtkLeadContainerClass>) @extends Container, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::clapper_gtk_lead_container_get_type(),
    }
}

impl LeadContainer {
        pub const NONE: Option<&'static LeadContainer> = None;
    

    #[doc(alias = "clapper_gtk_lead_container_new")]
    pub fn new() -> LeadContainer {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::clapper_gtk_lead_container_new()).unsafe_cast()
        }
    }

            // rustdoc-stripper-ignore-next
            /// Creates a new builder-pattern struct instance to construct [`LeadContainer`] objects.
            ///
            /// This method returns an instance of [`LeadContainerBuilder`](crate::builders::LeadContainerBuilder) which can be used to create [`LeadContainer`] objects.
            pub fn builder() -> LeadContainerBuilder {
                LeadContainerBuilder::new()
            }
        
}

impl Default for LeadContainer {
                     fn default() -> Self {
                         Self::new()
                     }
                 }
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`LeadContainer`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct LeadContainerBuilder {
            builder: glib::object::ObjectBuilder<'static, LeadContainer>,
        }

        impl LeadContainerBuilder {
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
        }

                            pub fn blocked_actions(self, blocked_actions: VideoActionMask) -> Self {
                            Self { builder: self.builder.property("blocked-actions", blocked_actions), }
                        }

                            pub fn leading(self, leading: bool) -> Self {
                            Self { builder: self.builder.property("leading", leading), }
                        }
    ...
    // rustdoc-stripper-ignore-next
    /// Build the [`LeadContainer`].
    #[must_use = "Building the object from the builder is usually expensive and is not expected to have side effects"]
    pub fn build(self) -> LeadContainer {
    self.builder.build() }
}
...
pub trait LeadContainerExt: IsA<LeadContainer> + sealed::Sealed + 'static {
    ...
    fn blocked_actions(&self) -> VideoActionMask {
        unsafe {
            from_glib(ffi::clapper_gtk_lead_container_get_blocked_actions(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "clapper_gtk_lead_container_get_leading")]
    #[doc(alias = "get_leading")]
    fn is_leading(&self) -> bool {
        unsafe {
            from_glib(ffi::clapper_gtk_lead_container_get_leading(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "clapper_gtk_lead_container_set_blocked_actions")]
    fn set_blocked_actions(&self, actions: VideoActionMask) {
        unsafe {
            ffi::clapper_gtk_lead_container_set_blocked_actions(self.as_ref().to_glib_none().0, actions.into_glib());
        }
    }

    #[doc(alias = "clapper_gtk_lead_container_set_leading")]
    fn set_leading(&self, leading: bool) {
        unsafe {
            ffi::clapper_gtk_lead_container_set_leading(self.as_ref().to_glib_none().0, leading.into_glib());
        }
    }

    #[doc(alias = "blocked-actions")]
    fn connect_blocked_actions_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_blocked_actions_trampoline<P: IsA<LeadContainer>, F: Fn(&P) + 'static>(this: *mut ffi::ClapperGtkLeadContainer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(LeadContainer::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    #[doc(alias = "leading")]
    fn connect_leading_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_leading_trampoline<P: IsA<LeadContainer>, F: Fn(&P) + 'static>(this: *mut ffi::ClapperGtkLeadContainer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(LeadContainer::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
...
impl<O: IsA<LeadContainer>> LeadContainerExt for O {}
