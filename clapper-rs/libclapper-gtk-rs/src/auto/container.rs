...
impl Container {
    ...
    pub fn new() -> Container {
        ...
        unsafe {
            gtk::Widget::from_glib_none(ffi::clapper_gtk_container_new()).unsafe_cast()
        }
    }
...
pub trait ContainerExt: IsA<Container> + sealed::Sealed + 'static {
    ...
    fn adaptive_height(&self) -> i32 {
        unsafe {
            ffi::clapper_gtk_container_get_adaptive_height(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn adaptive_width(&self) -> i32 {
        unsafe {
            ffi::clapper_gtk_container_get_adaptive_width(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn child(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::clapper_gtk_container_get_child(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn height_target(&self) -> i32 {
        unsafe {
            ffi::clapper_gtk_container_get_height_target(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn width_target(&self) -> i32 {
        unsafe {
            ffi::clapper_gtk_container_get_width_target(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn set_child(&self, child: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::clapper_gtk_container_set_child(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0);
        }
    }
    ...
    fn connect_adapt<F: Fn(&Self, bool) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn adapt_trampoline<P: IsA<Container>, F: Fn(&P, bool) + 'static>(this: *mut ffi::ClapperGtkContainer, adapt: glib::ffi::gboolean, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Container::from_glib_borrow(this).unsafe_cast_ref(), from_glib(adapt))
        }
        unsafe {
    ...
    fn connect_adaptive_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_adaptive_height_trampoline<P: IsA<Container>, F: Fn(&P) + 'static>(this: *mut ffi::ClapperGtkContainer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
    ...
    fn connect_adaptive_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_adaptive_width_trampoline<P: IsA<Container>, F: Fn(&P) + 'static>(this: *mut ffi::ClapperGtkContainer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Container::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_height_target_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_target_trampoline<P: IsA<Container>, F: Fn(&P) + 'static>(this: *mut ffi::ClapperGtkContainer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Container::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_width_target_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_target_trampoline<P: IsA<Container>, F: Fn(&P) + 'static>(this: *mut ffi::ClapperGtkContainer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Container::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
