...
impl TitleHeader {
    ...
    pub fn new() -> TitleHeader {
        ...
        unsafe {
            gtk::Widget::from_glib_none(ffi::clapper_gtk_title_header_new()).unsafe_cast()
        }
    }
    ...
    pub fn current_title(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::clapper_gtk_title_header_get_current_title(self.to_glib_none().0))
        }
    }
    ...
    pub fn is_fallback_to_uri(&self) -> bool {
        unsafe {
            from_glib(ffi::clapper_gtk_title_header_get_fallback_to_uri(self.to_glib_none().0))
        }
    }
    ...
    pub fn set_fallback_to_uri(&self, enabled: bool) {
        unsafe {
            ffi::clapper_gtk_title_header_set_fallback_to_uri(self.to_glib_none().0, enabled.into_glib());
        }
    }

    #[doc(alias = "current-title")]
    pub fn connect_current_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_current_title_trampoline<F: Fn(&TitleHeader) + 'static>(this: *mut ffi::ClapperGtkTitleHeader, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    pub fn connect_fallback_to_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_fallback_to_uri_trampoline<F: Fn(&TitleHeader) + 'static>(this: *mut ffi::ClapperGtkTitleHeader, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
