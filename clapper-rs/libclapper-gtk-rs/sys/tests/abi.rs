...
static PACKAGES: &[&str] = &["clapper-gtk-0.0"];
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ("CLAPPER_GTK_MAJOR_VERSION", "0"),
    ("CLAPPER_GTK_MICRO_VERSION", "0"),
    ("CLAPPER_GTK_MINOR_VERSION", "7"),
    ("CLAPPER_GTK_VERSION_S", "0.7.0"),
    ("(guint) CLAPPER_GTK_VIDEO_ACTION_ANY", "67108863"),
    ("(guint) CLAPPER_GTK_VIDEO_ACTION_NONE", "0"),
    ("(guint) CLAPPER_GTK_VIDEO_ACTION_REVEAL_OVERLAYS", "1"),
    ("(guint) CLAPPER_GTK_VIDEO_ACTION_SEEK_REQUEST", "8"),
