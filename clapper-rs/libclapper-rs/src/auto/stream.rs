...
pub trait StreamExt: IsA<Stream> + sealed::Sealed + 'static {
    ...
    fn stream_type(&self) -> StreamType {
        unsafe {
            from_glib(ffi::clapper_stream_get_stream_type(
    ...
    fn title(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_full(ffi::clapper_stream_get_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<Stream>, F: Fn(&P) + 'static>(
            this: *mut ffi::ClapperStream,
