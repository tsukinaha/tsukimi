...
use crate::{ffi, DiscovererDiscoveryMode, Feature};
use glib::{
    prelude::*,
...
impl Discoverer {
    ...
    pub fn new() -> Discoverer {
        ...
        unsafe { from_glib_full(ffi::clapper_discoverer_new()) }
    }
    ...
    pub fn discovery_mode(&self) -> DiscovererDiscoveryMode {
        unsafe {
            from_glib(ffi::clapper_discoverer_get_discovery_mode(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn connect_discovery_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_discovery_mode_trampoline<F: Fn(&Discoverer) + 'static>(
            this: *mut ffi::ClapperDiscoverer,
        ...
        unsafe {
            ...
            connect_raw(
                ...
                b"notify::discovery-mode\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_discovery_mode_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
...
impl DiscovererBuilder {
    ...
    pub fn discovery_mode(self, discovery_mode: DiscovererDiscoveryMode) -> Self {
        Self {
            builder: self.builder.property("discovery-mode", discovery_mode),
        }
    }
