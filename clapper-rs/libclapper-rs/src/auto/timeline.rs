...
impl Timeline {
    ...
    pub fn marker(&self, index: u32) -> Option<Marker> {
        unsafe {
            from_glib_full(ffi::clapper_timeline_get_marker(
                self.to_glib_none().0,
                index,
            ))
        }
    ...
    pub fn n_markers(&self) -> u32 {
        unsafe { ffi::clapper_timeline_get_n_markers(self.to_glib_none().0) }
    }

    #[doc(alias = "clapper_timeline_insert_marker")]
    pub fn insert_marker(&self, marker: &Marker) -> bool {
        unsafe {
            from_glib(ffi::clapper_timeline_insert_marker(
                self.to_glib_none().0,
    ...
    pub fn connect_n_markers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_n_markers_trampoline<F: Fn(&Timeline) + 'static>(
            this: *mut ffi::ClapperTimeline,
        ...
        unsafe {
            ...
            connect_raw(
                ...
                b"notify::n-markers\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_n_markers_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
