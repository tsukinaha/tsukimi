...
impl VideoStream {
    ...
    pub fn bitrate(&self) -> u32 {
        unsafe { ffi::clapper_video_stream_get_bitrate(self.to_glib_none().0) }
    }

    #[doc(alias = "clapper_video_stream_get_codec")]
    #[doc(alias = "get_codec")]
    pub fn codec(&self) -> Option<glib::GString> {
        unsafe { from_glib_full(ffi::clapper_video_stream_get_codec(self.to_glib_none().0)) }
    }

    #[doc(alias = "clapper_video_stream_get_fps")]
    #[doc(alias = "get_fps")]
    pub fn fps(&self) -> f64 {
        unsafe { ffi::clapper_video_stream_get_fps(self.to_glib_none().0) }
    }

    #[doc(alias = "clapper_video_stream_get_height")]
    #[doc(alias = "get_height")]
    pub fn height(&self) -> i32 {
        unsafe { ffi::clapper_video_stream_get_height(self.to_glib_none().0) }
    }
    ...
    pub fn pixel_format(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_full(ffi::clapper_video_stream_get_pixel_format(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn width(&self) -> i32 {
        unsafe { ffi::clapper_video_stream_get_width(self.to_glib_none().0) }
    }

    #[doc(alias = "bitrate")]
    pub fn connect_bitrate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_bitrate_trampoline<F: Fn(&VideoStream) + 'static>(
            this: *mut ffi::ClapperVideoStream,
    ...
    pub fn connect_codec_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_codec_trampoline<F: Fn(&VideoStream) + 'static>(
            this: *mut ffi::ClapperVideoStream,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_fps_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_fps_trampoline<F: Fn(&VideoStream) + 'static>(
            this: *mut ffi::ClapperVideoStream,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::fps\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_fps_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    pub fn connect_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<F: Fn(&VideoStream) + 'static>(
            this: *mut ffi::ClapperVideoStream,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_pixel_format_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pixel_format_trampoline<F: Fn(&VideoStream) + 'static>(
            this: *mut ffi::ClapperVideoStream,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_pixel_format_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    pub fn connect_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<F: Fn(&VideoStream) + 'static>(
            this: *mut ffi::ClapperVideoStream,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
