...
use crate::{ffi, MediaItem, QueueProgressionMode};
use glib::{
    prelude::*,
...
impl Queue {
    ...
    pub fn find_item(&self, item: &MediaItem) -> Option<u32> {
        unsafe {
            ...
            let ret = from_glib(ffi::clapper_queue_find_item(
                self.to_glib_none().0,
                item.to_glib_none().0,
                index.as_mut_ptr(),
            ));
    ...
    pub fn current_index(&self) -> u32 {
        unsafe { ffi::clapper_queue_get_current_index(self.to_glib_none().0) }
    }
    ...
    pub fn current_item(&self) -> Option<MediaItem> {
        unsafe { from_glib_full(ffi::clapper_queue_get_current_item(self.to_glib_none().0)) }
    }
    ...
    pub fn is_gapless(&self) -> bool {
        unsafe { from_glib(ffi::clapper_queue_get_gapless(self.to_glib_none().0)) }
    }
    ...
    pub fn is_instant(&self) -> bool {
        unsafe { from_glib(ffi::clapper_queue_get_instant(self.to_glib_none().0)) }
    }

    #[doc(alias = "clapper_queue_get_item")]
    #[doc(alias = "get_item")]
    pub fn item(&self, index: u32) -> Option<MediaItem> {
        unsafe { from_glib_full(ffi::clapper_queue_get_item(self.to_glib_none().0, index)) }
    }
    ...
    pub fn n_items(&self) -> u32 {
        unsafe { ffi::clapper_queue_get_n_items(self.to_glib_none().0) }
    }
    ...
    pub fn progression_mode(&self) -> QueueProgressionMode {
        unsafe {
            from_glib(ffi::clapper_queue_get_progression_mode(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn item_is_current(&self, item: &MediaItem) -> bool {
        unsafe {
            from_glib(ffi::clapper_queue_item_is_current(
                self.to_glib_none().0,
                item.to_glib_none().0,
            ))
        }
    ...
    pub fn select_index(&self, index: u32) -> bool {
        unsafe {
            from_glib(ffi::clapper_queue_select_index(
                self.to_glib_none().0,
                index,
            ))
        }
    ...
    pub fn select_item(&self, item: Option<&MediaItem>) -> bool {
        unsafe {
            from_glib(ffi::clapper_queue_select_item(
                self.to_glib_none().0,
                item.to_glib_none().0,
            ))
        }
    ...
    pub fn select_next_item(&self) -> bool {
        unsafe { from_glib(ffi::clapper_queue_select_next_item(self.to_glib_none().0)) }
    }

    #[doc(alias = "clapper_queue_select_previous_item")]
    pub fn select_previous_item(&self) -> bool {
        unsafe {
            from_glib(ffi::clapper_queue_select_previous_item(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn steal_index(&self, index: u32) -> Option<MediaItem> {
        unsafe { from_glib_full(ffi::clapper_queue_steal_index(self.to_glib_none().0, index)) }
    }
    ...
    pub fn connect_current_index_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_current_index_trampoline<F: Fn(&Queue) + 'static>(
            this: *mut ffi::ClapperQueue,
    ...
    pub fn connect_current_item_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_current_item_trampoline<F: Fn(&Queue) + 'static>(
            this: *mut ffi::ClapperQueue,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::current-item\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_current_item_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    pub fn connect_gapless_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_gapless_trampoline<F: Fn(&Queue) + 'static>(
            this: *mut ffi::ClapperQueue,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::gapless\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_gapless_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    pub fn connect_instant_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_instant_trampoline<F: Fn(&Queue) + 'static>(
            this: *mut ffi::ClapperQueue,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::instant\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_instant_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    pub fn connect_n_items_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_n_items_trampoline<F: Fn(&Queue) + 'static>(
            this: *mut ffi::ClapperQueue,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_progression_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_progression_mode_trampoline<F: Fn(&Queue) + 'static>(
            this: *mut ffi::ClapperQueue,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::progression-mode\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_progression_mode_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
...
impl QueueBuilder {
    ...
    pub fn gapless(self, gapless: bool) -> Self {
        Self {
            builder: self.builder.property("gapless", gapless),
        }
    }

    pub fn instant(self, instant: bool) -> Self {
        Self {
            builder: self.builder.property("instant", instant),
        }
    }

    pub fn progression_mode(self, progression_mode: QueueProgressionMode) -> Self {
        Self {
            builder: self.builder.property("progression-mode", progression_mode),
        }
    }
