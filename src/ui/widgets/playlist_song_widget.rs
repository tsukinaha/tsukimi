...
pub(crate) mod imp {
    ...
    #[template(resource = "/moe/tsuna/tsukimi/ui/playlist_song_widget.ui")]
    #[properties(wrapper_type = super::PlaylistSongWidget)]
    pub struct PlaylistSongWidget {
    ...
    impl ObjectSubclass for PlaylistSongWidget {
        const NAME: &'static str = "PlaylistSongWidget";
        type Type = super::PlaylistSongWidget;
    ...
    impl ObjectImpl for PlaylistSongWidget {
        fn constructed(&self) {
    ...
    impl WidgetImpl for PlaylistSongWidget {}
    impl ListBoxRowImpl for PlaylistSongWidget {}

    impl PlaylistSongWidget {
...
glib::wrapper! {
    pub struct PlaylistSongWidget(ObjectSubclass<imp::PlaylistSongWidget>)
