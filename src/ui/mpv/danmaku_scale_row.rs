...
mod imp {
    ...
    #[template(resource = "/moe/tsuna/tsukimi/ui/danmaku_scale_row.ui")]
    #[properties(wrapper_type = super::DanmakuScaleRow)]
    pub struct DanmakuScaleRow {
        #[template_child]
    ...
    impl ObjectSubclass for DanmakuScaleRow {
        const NAME: &'static str = "DanmakuScaleRow";
        type Type = super::DanmakuScaleRow;
    ...
    impl ObjectImpl for DanmakuScaleRow {
        fn constructed(&self) {
    ...
    impl WidgetImpl for DanmakuScaleRow {}
    impl ListBoxRowImpl for DanmakuScaleRow {}
    impl PreferencesRowImpl for DanmakuScaleRow {}

    impl DanmakuScaleRow {
...
glib::wrapper! {
    pub struct DanmakuScaleRow(ObjectSubclass<imp::DanmakuScaleRow>)
...
impl Default for DanmakuScaleRow {
    fn default() -> Self {
        Self::new()
    }
}
